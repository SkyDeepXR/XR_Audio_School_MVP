...
public class AudioSpectralizer : MonoBehaviour
{
    
    [FormerlySerializedAs("_vinylSource")] [SerializeField] private AudioSource _sphereSource;
    ...
    void Start()
    {
        _sphereSource.GetComponent<AudioSource>();
    ...
    {
        _sphereSource.GetSpectrumData(_samples, 0, FFTWindow.Blackman);
    }
}
