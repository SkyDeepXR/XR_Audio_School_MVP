...
namespace DA_Assets.Shared
{
    public class ContextMenuItems : MonoBehaviour
    {
        ...
        private static void SetSelectedAsParentForAllChilds_OnClick()
        {
            ...
            SetSelectedAsParentForAllChild(selectedGameObject, childs);
            foreach (Transform child in childs)
            {
                child.SetParent(selectedGameObject.transform);
            }

            void SetSelectedAsParentForAllChild(GameObject @object, List<Transform> childs)
            {
                if (@object == null)
                    return;
                ...
                foreach (Transform child in @object.transform)
                {
                    ...
                    SetSelectedAsParentForAllChild(child.gameObject, childs);
                }
            }
        }
