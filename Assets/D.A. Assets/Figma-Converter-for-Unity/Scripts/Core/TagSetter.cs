    ...
    public class TagSetter : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        private void SetTagsByFigma(FObject parent)
        {
            ...
            for (int i = 0; i < parent.Children.Count; i++)
            {
                ...
                child.Data.ObjectName = monoBeh.AssetTools.GetFcuName(child, FcuNameType.Object);
                child.Data.FileName = monoBeh.AssetTools.GetFcuName(child, FcuNameType.File);
                child.Data.FieldName = monoBeh.AssetTools.GetFcuName(child, FcuNameType.Field);
                child.Data.MethodName = monoBeh.AssetTools.GetFcuName(child, FcuNameType.Method);
                child.Data.UitkGuid = monoBeh.AssetTools.GetFcuName(child, FcuNameType.UitkGuid);
