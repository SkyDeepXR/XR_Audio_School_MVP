...
#if UITK_LINKER_EXISTS
        [SerializeField] UitkLinkingMode uitkLinkingMode = UitkLinkingMode.Name;
        public UitkLinkingMode UitkLinkingMode { get => uitkLinkingMode; set => SetValue(ref uitkLinkingMode, value); }
#endif
