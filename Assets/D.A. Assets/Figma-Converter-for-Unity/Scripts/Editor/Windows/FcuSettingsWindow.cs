...
namespace DA_Assets.FCU
{
    ...
    internal class FcuSettingsWindow : DAInspectorWindow<FcuSettingsWindow, FcuEditor, FigmaConverterUnity>
    {
        ...
        {         
            ...
            //UITab scriptGeneratorTab = new UITab(FcuLocKey.label_script_generator.Localize(), FcuLocKey.tooltip_script_generator.Localize(), this.ScriptGenTab.Draw);
        ...
        private ScriptGenTab scriptGenTab;
        internal ScriptGenTab ScriptGenTab => monoBeh.Bind(ref scriptGenTab, this);
